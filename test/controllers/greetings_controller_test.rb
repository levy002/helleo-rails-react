...
class GreetingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create greeting' do
    assert_difference('Greeting.count') do
      post greetings_url, params: { greeting: { language: @greeting.language, message: @greeting.message } }
    end
  ...
  test 'should update greeting' do
    patch greeting_url(@greeting), params: { greeting: { language: @greeting.language, message: @greeting.message } }
